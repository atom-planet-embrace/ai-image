use ai_image::{GenericImage, GenericImageView, ImageBuffer, Pixel, Primitive};
...
fn main() {
    h_concat(&[
        ai_image::open("examples/concat/200x300.png").unwrap(),
        ai_image::open("examples/concat/300x300.png").unwrap(),
        ai_image::open("examples/concat/400x300.png").unwrap(),
    ])
    ...
    S: Primitive + 'static,
{
    ...
    let mut imgbuf = ai_image::ImageBuffer::new(img_width_out, img_height_out);
